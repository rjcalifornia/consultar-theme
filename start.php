 ...
 */
function consultar_theme_pagesetup() {
 ...
 * @return array
 */
function consultar_theme_setup_head($hook, $type, $data) {
	...
	$data['links']['apple-touch-icon'] = array(
		...
		'href' => elgg_get_simplecache_url('consultar_theme/homescreen.png'),
	);
